...
<screen name="MyUniverse-Setup" position="0,0" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">
	...
	<ePixmap name="menu-top" position="0,0" size="1920,460" pixmap="UniverseHD/construct/shadow/top.png" alphatest="blend" zPosition="-10" />
	...
	<ePixmap pixmap="UniverseHD/construct/backgrounds/background-exit-button.png" size="10,55" position="1850,142" />
	...
	<ePixmap name="" position="0,0" size="1920,1080" pixmap="UniverseHD/construct/shadow/right.png" zPosition="-20" alphatest="blend" />
	<ePixmap position="1635,785" size="232,254" zPosition="-9" pixmap="UniverseHD/construct/backgrounds/background-symbol.png" transparent="0" alphatest="blend" />
	<ePixmap position="63,150" size="937,887" zPosition="-3" pixmap="UniverseHD/construct/backgrounds/background-window-title.png" alphatest="blend" />
	<ePixmap alphatest="blend" position="1000,150" size="46,887" zPosition="-5" pixmap="UniverseHD/construct/shadow/window-right.png" />
	<ePixmap alphatest="blend" position="63,1037" size="937,48" zPosition="-5" pixmap="UniverseHD/construct/shadow/window-bottom.png" />
	<ePixmap alphatest="blend" position="1000,1037" size="46,48" zPosition="-5" pixmap="UniverseHD/construct/shadow/window-br.png" />
	<eLabel position="63,150" size="937,887" zPosition="-100" backgroundColor="skin-transparency" />
	<ePixmap pixmap="UniverseHD/construct/symbols/skin.png" position="1635,785" size="232,254" alphatest="blend" />
...
"""
	...
	def __init__(self, session, args=None, picPath=None):
		...
		self.backgroundsDir = "/usr/share/enigma2/UniverseHD/construct/backgrounds/"
		self.skinFileBackup = "/usr/share/enigma2/UniverseHD/skin.xml.backup"
		self.skinFile = "/usr/share/enigma2/UniverseHD/skin.xml"
